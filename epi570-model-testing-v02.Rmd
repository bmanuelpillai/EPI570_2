...
```{r Omega.m = 1 Graphs}
par(mfrow = c(2,2))
plot(mod, y = c('uv.m.e.num', 'uv.m.i.a.num', 'uv.m.i.s.num'),
          main = "Unvaccinated Males Over Time\n(Baseline Vaccination)",
          xlim = c(750, 15000), run = 1)
     legend("topright", legend = c("Susceptible Males", "Asymptomatic Males","Symptomatic Males"), col = c("red", "blue", "green"), pch = 19, cex = 0.6)
plot(mod, y = c('v.m.e.num', 'v.m.i.a.num', 'v.m.i.s.num'),
          main = "Vaccinated Males Over Time\n(Baseline Vaccination)",
          xlim = c(750, 15000), run = 1)
     legend("topright", legend = c("Susceptible Males", "Asymptomatic Males","Symptomatic Males"), col = c("red", "blue", "green"), pch = 19,cex = 0.6)
plot(mod, y = c('uv.f.e.num', 'uv.f.i.a.num', 'uv.f.i.s.num'),
          main = "Unvaccinated females Over Time\n(Baseline Vaccination)",
          xlim = c(750, 15000), run = 1)
     legend("topright", legend = c("Susceptible females", "Asymptomatic females","Symptomatic females"), col = c("red", "blue", "green"), pch = 19, cex = 0.6)
plot(mod, y = c('v.f.e.num', 'v.f.i.a.num', 'v.f.i.s.num'),
          main = "Vaccinated females Over Time\n(Baseline Vaccination)",
          xlim = c(750, 15000), run = 1)
     legend("topright", legend = c("Susceptible females", "Asymptomatic females","Symptomatic females"), col = c("red", "blue", "green"), pch = 19,cex = 0.6)
```
...
par(mfrow = c(1,2))
plot(mod, y = "m.prev", 
     main = "Prevalence of infection, males")

plot(mod, y = "f.prev", 
     main = "Prevalence of infection, females")
```

```{r}
par(mfrow = c(1,2))
plot(mod, y = "m.vax.prev", 
     main = "Prevalence of vax, males")

plot(mod, y = "f.vax.prev", 
     main = "Prevalence of vax, females")
```
...
par(mfrow = c(1,2))
plot(mod3, y = "m.prev", 
     main = "Increase Childhood Female Vaccination\nProportional Prevalence\nMales",
     xlim = c(750, 15000),
     ylim = c(0.6,0.8))
legend("topright", legend = c("omega.f = 0.3", "omega.m = 0.4","omega.m = 0.5", "omega.m = 0.6"), col = c("red", "blue", "green", "purple"), pch = 19, cex = 0.6)

plot(mod3, y = "f.prev", 
     main = "Increase Childhood Female Vaccination\nProportional Prevalence\nFemales",
     xlim = c(750, 15000),
     ylim = c(0.6,0.8))
legend("topright", legend = c("omega.m = 0.3", "omega.m = 0.4","omega.m = 0.5", "omega.m = 0.6"), col = c("red", "blue", "green", "purple"), pch = 19, cex = 0.6)
...
# Combine Results
female_vaccination <- data.frame(
  Scenario = c("omega.f = 0.4", "omega.f = 0.5", "omega.f = 0.6"),
  NIA_Female = c(NIAF2, NIAF3, NIAF4),
  Percent_Averted_Female = Percent_Averted_Females,
  NNT_Female = NNT_Females,
  NIA_Male = c(NIAM2, NIAM3, NIAM4),
