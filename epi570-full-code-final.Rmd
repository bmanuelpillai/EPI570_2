...
## ADD MODEL ELEMENTS-BASELINE
```{r, adding elements to model-baseline}
...
### PLOTS-BASELINE
```{r, Proportional Prevalence-baseline}
par(mfrow = c(1,2))
...
## ADD MODEL ELEMENTS-INT 01
```{r, adding elements to model int01}
# Male Population Size
mod <- mutate_epi(mod, m.num = uv.m.ue.num + uv.m.e.num + uv.m.i.a.num + uv.m.i.s.num + 
                               v.m.ue.num  + v.m.e.num  + v.m.i.a.num  + v.m.i.s.num)
...
### PLOTS-INT 01
```{r, Proportional Prevalence-int01}
par(mfrow = c(1,2))
...
## ADD MODEL ELEMENTS-INT 02
```{r, adding elements to model int02}
# Male Population Size
mod <- mutate_epi(mod, m.num = uv.m.ue.num + uv.m.e.num + uv.m.i.a.num + uv.m.i.s.num + 
                               v.m.ue.num  + v.m.e.num  + v.m.i.a.num  + v.m.i.s.num)
...
### PLOTS-INT 02
```{r, Proportional Prevalence-int 02}
par(mfrow = c(1,2))
...
```{r Population Attributable Fraction omega}
...
```{r Population Attributable Fraction kappa}
