...
control2 <- control.dcm(nsteps = (50*365), new.mod = Vaccination)
...
## INTERVENTION SCENARIO #3: COMBINED VACCINATINO STRATEGY
...
control3 <- control.dcm(nsteps = (50*365), new.mod = Vaccination)
...
mod2 <- mutate_epi(mod, i.f.num = uv.f.i.a.num + uv.f.i.s.num + v.f.i.a.num  + v.f.i.s.num)
...
mod3 <- mutate_epi(mod, i.f.num = uv.f.i.a.num + uv.f.i.s.num + v.f.i.a.num  + v.f.i.s.num)
...
legend("topright", legend = c("omega.m = 0.1 + kappa = 0.01", "omega.m = 0.3 + kappa = 0.02","omega.m = 0.5 + kappa = 0.03", "omega.m = 0.7 + kappa = 0.04"), col = c("red", "blue", "green", "purple"), pch = 19)
```
