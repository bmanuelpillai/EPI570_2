...
```{r Unvaccinated Compartment asymptomatic Graphs}
par(mfrow = c(2,3))
...
```{r Omega.m = 1 Graphs}
par(mfrow = c(2,2))
plot(mod1, y = c('uv.m.e.num', 'uv.m.i.a.num', 'uv.m.i.s.num'),
...
plot(mod1, y = c('v.m.e.num', 'v.m.i.a.num', 'v.m.i.s.num'),
          main = "Vaccinated Males Over Time\n(Baseline Vaccination)",
          xlim = c(750, 15000), run = 1)
     legend("topright", legend = c("Susceptible Males", "Asymptomatic Males","Symptomatic Males"), col = c("red", "blue", "green"), pch = 19,cex = 0.6)
plot(mod1, y = c('uv.f.e.num', 'uv.f.i.a.num', 'uv.f.i.s.num'),
...
plot(mod1, y = c('v.f.e.num', 'v.f.i.a.num', 'v.f.i.s.num'),
