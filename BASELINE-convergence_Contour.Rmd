...
Modified code to include contour plots
...
plot(mod, y = "m.prev", 
     ...
     ylim = c(0.5,0.65), xlim = c(11000, 30000),
     col = "blue")
...
plot(mod, y = "m.vax.prev", 
     main = "Proportional Prevalence Vaccinated Males\n(Baseline)",
     ylim = c(0.4,0.65), xlim = c(11000, 30000),
     col = "blue")

plot(mod, y = "f.vax.prev", 
     main = "Proportional Prevalence Vaccinated Females\n(Baseline)",
     ylim = c(0.4,0.65), xlim = c(11000, 30000),
     col = "pink")
```
```{r Incidence}
...
```{r TOM's Contour Plot Code for Kappa}
...
```{r TOM's Contour Plot Code for Omega}
...
mod <- dcm(param.c, init, control.b)
mod <- mutate_epi(mod, i.m.num = uv.m.i.a.num + uv.m.i.s.num + v.m.i.a.num  + v.m.i.s.num)
mod <- mutate_epi(mod, i.f.num = uv.f.i.a.num + uv.f.i.s.num + v.f.i.a.num  + v.f.i.s.num)
mod <- mutate_epi(mod, si.flow = si.m.flow + si.f.flow)
