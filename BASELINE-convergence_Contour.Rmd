...
```{r}
pacman::p_load(pacman, EpiModel, ggplot2, tidyverse, reshape2, viridis, metR)
```
...
kappa.m <- seq(0.01, 0.1, 0.02)
kappa.f <- seq(0.01, 0.1, 0.02)
...
omega.m <- seq(0.45, 0.6, 0.05)
omega.f <- seq(0.45, 0.6, 0.05)
