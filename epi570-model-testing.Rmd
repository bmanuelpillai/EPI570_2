...
param <- param.dcm( # FOI parameters
                    ...
                    # sympotmatic parameters
                    zeta.v = (0.1/365) , zeta.s = (0.1/365))

init <- init.dcm( # males
                 uv.m.ue.num = 1600000, uv.m.e.num = 3800000,
                 uv.m.i.a.num = 1300000, uv.m.i.s.num= 1300000,
                 v.m.ue.num = 304000, v.m.e.num = 304000, 
                 v.m.i.a.num = 1300000, v.m.i.s.num = 1300000,
                 # females
                 uv.f.ue.num = 1700000, uv.f.e.num = 3800000, 
                 uv.f.i.a.num = 3000000, uv.f.i.s.num = 3000000,
                 v.f.ue.num = 240000, v.f.e.num = 240000, 
                 v.f.i.a.num = 1300000, v.f.i.s.num = 1300000,
                 # flows
