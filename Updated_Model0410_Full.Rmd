...
init <- init.dcm(uv.m.ue.num = 1600000, uv.m.e.num = 3800000,
...
scen1_inf <- sum(df1$si.flow)
inf_avert1 <- baseline_inf - scen1_inf
...
print(c(baseline_inf, scen1_inf, scen2_inf, scen3_inf, scen4_inf))
print(c(inf_avert1, inf_avert2, inf_avert3, inf_avert4))

# Plot results
#plot(mod, y = "si.flow", main = "Incidence (Baseline)", ylim = c(0, 0.2))
#plot(mod, y = c("i.num", "u.num"), main = "Prevalence (Baseline)")

#plot(mod1, y = "si.flow", main = "Incidence (Scenario 1)")
#plot(mod2, y = "si.flow", main = "Incidence (Scenario 2)")
#plot(mod3, y = "si.flow", main = "Incidence (Scenario 3)")

#par(mfrow = c(2,2))
#plot(mod1, y = c("i.num", "u.num"), main = "Prevalence (Scenario 1)")
#plot(mod2, y = c("i.num", "u.num"), main = "Prevalence (Scenario 2)")
#plot(mod3, y = c("i.num", "u.num"), main = "Prevalence (Scenario 3)")
```
