...
#
# MALES
dS.m.ue <- (1-(0.5 * omega.m * chi * mu * num)) - ((1/8) * s.m.ue.num)

dS.m.e <- ((1/8) * s.m.ue.num) - (lambda.m.s.a * s.m.e.num) + (delta.s.a * i.m.s.a.num) + (delta.s.s * i.m.s.s.num) - (kappa.m * s.m.e.num) - ((1/11) * s.m.e.num)

dI.m.s.a <- (lambda.m.s.a * s.m.e.num) - (zeta.s * i.m.s.a.num) - (delta.s.a * i.m.s.a.num) - ((1/11) * i.m.s.a.num)

dI.m.s.s <- (zeta.s * i.m.s.a.num) - (delta.s.s * i.m.s.s.num) - ((1/11) * i.m.s.s.num)


dV.m.ue <- (0.5 * omega.m * chi * mu * num) - ((1/8) * v.m.ue.num) 

dV.m.e <- ((1/8) * v.m.ue.num) - (lambda.m.v.a * v.m.e.num) + (delta.v.a * i.m.v.a.num) + (delta.v.s * i.m.v.s.num) + (kappa.m * s.m.e.num) - ((1/11) * v.m.e.num)

dI.m.v.a <- (lambda.m.v.a * v.m.e.num) - (zeta.v * i.m.v.a.num) - (delta.v.a * i.m.v.a.num) - ((1/11) * i.m.v.a.num)

dI.m.v.s <- (zeta.v * i.m.v.a.num) - (delta.v.s * i.m.v.s.num) - ((1/11) * i.m.v.s.num)

# FEMALES
dS.f.ue <- (1-(0.5 * omega.f * chi * mu * num)) - ((1/8) * s.f.ue.num)

dS.f.e <- ((1/8) * s.f.ue.num) - (lambda.f.s.a * s.f.e.num) + (delta.s.a * i.f.s.a.num) + (delta.s.s * i.f.s.s.num) - (kappa.f * s.f.e.num) - ((1/11) * s.f.e.num)

dI.f.s.a <- (lambda.f.s.a * s.f.e.num) - (zeta.s * i.f.s.a.num) - (delta.s.a * i.f.s.a.num) - ((1/11) * i.f.s.a.num)

dI.f.s.s <- (zeta.s * i.f.s.a.num) - (delta.s.s * i.f.s.s.num) - ((1/11) * i.f.s.s.num)


dV.f.ue <- (0.5 * omega.f * chi * mu * num) - ((1/8) * v.f.ue.num) 

dV.f.e <- ((1/8) * v.f.ue.num) - (lambda.f.v.a * v.f.e.num) + (delta.v.a * i.f.v.a.num) + (delta.v.s * i.f.v.s.num) + (kappa.f * s.f.e.num) - ((1/11) * v.f.e.num)

dI.f.v.a <- (lambda.f.v.a * v.f.e.num) - (zeta.v * i.f.v.a.num) - (delta.v.a * i.f.v.a.num) - ((1/11) * i.f.v.a.num)

dI.f.v.s <- (zeta.v * i.f.v.a.num) - (delta.v.s * i.f.v.s.num) - ((1/11) * i.f.v.s.num)
