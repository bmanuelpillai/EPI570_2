...
#4. Define Additional parameters
  delta.s.a <- 1/dur.inf.asy
  delta.s.s <- 1/dur.inf.s
...
# nu is birthrate
# MALES
dS.m.ue <- ((0.5 * (1-omega.m) * chi * nu * num)) - (age.in * s.m.ue.num)
...
dV.m.ue <- (0.5 * omega.m * chi * nu * num) - (age.in * v.m.ue.num) 
...
dS.f.ue <- ((0.5 * (1-omega.f) * chi * nu * num)) - (age.in * s.f.ue.num) # - death.rate?

dS.f.e <- (age.in * s.f.ue.num) - (lambda.f.s.a * s.f.e.num) + (delta.s.a * i.f.s.a.num) + (delta.s.s * i.f.s.s.num) - (kappa.f * s.f.e.num) - (age.out * s.f.e.num) # - death.rate?

dI.f.s.a <- (lambda.f.s.a * s.f.e.num) - (zeta.s * i.f.s.a.num) - (delta.s.a * i.f.s.a.num) - (age.out * i.f.s.a.num) # -death.rate?

dI.f.s.s <- (zeta.s * i.f.s.a.num) - (delta.s.s * i.f.s.s.num) - (age.out * i.f.s.s.num) # -death.rate?


dV.f.ue <- (0.5 * omega.f * chi * nu * num) - (age.in * v.f.ue.num) 
