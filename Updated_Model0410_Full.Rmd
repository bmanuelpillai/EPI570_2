...
# nu is birthrate
# MALES
dS.m.ue <- ((0.5 * (1-omega.m) * chi * nu * num)) - (age.in * s.m.ue.num) - (mu.ue * s.m.ue.num)

dS.m.e <- (age.in * s.m.ue.num) - (lambda.m.s.a * s.m.e.num) + (delta.s.a * i.m.s.a.num) + (delta.s.s * i.m.s.s.num) - (kappa * s.m.e.num) - (age.out * s.m.e.num) - (mu * s.m.e.num)

dI.m.s.a <- (lambda.m.s.a * s.m.e.num) - (zeta.s * i.m.s.a.num) - (delta.s.a * i.m.s.a.num) - (age.out * i.m.s.a.num) - (mu * i.m.s.a.num)

dI.m.s.s <- (zeta.s * i.m.s.a.num) - (delta.s.s * i.m.s.s.num) - (age.out * i.m.s.s.num) - (mu * i.m.s.s.num)


dV.m.ue <- (0.5 * omega.m * chi * nu * num) - (age.in * v.m.ue.num) - (mu.ue * v.m.ue.num) 

dV.m.e <- (age.in * v.m.ue.num) - (lambda.m.v.a * v.m.e.num) + (delta.v.a * i.m.v.a.num) + (delta.v.s * i.m.v.s.num) + (kappa * s.m.e.num) - (age.out * v.m.e.num) - (mu * v.m.e.num)
...
dS.f.ue <- ((0.5 * (1-omega.f) * chi * nu * num)) - (age.in * s.f.ue.num) - (mu.ue * s.f.ue.num)

dS.f.e <- (age.in * s.f.ue.num) - (lambda.f.s.a * s.f.e.num) + (delta.s.a * i.f.s.a.num) + (delta.s.s * i.f.s.s.num) - (kappa * s.f.e.num) - (age.out * s.f.e.num) - (mu * s.f.e.num)

dI.f.s.a <- (lambda.f.s.a * s.f.e.num) - (zeta.s * i.f.s.a.num) - (delta.s.a * i.f.s.a.num) - (age.out * i.f.s.a.num) - (mu * i.f.s.a.num)

dI.f.s.s <- (zeta.s * i.f.s.a.num) - (delta.s.s * i.f.s.s.num) - (age.out * i.f.s.s.num) - (mu * i.f.s.s.num)


dV.f.ue <- (0.5 * omega.f * chi * nu * num) - (age.in * v.f.ue.num) - (mu.ue * v.f.ue.num) 

dV.f.e <- (age.in * v.f.ue.num) - (lambda.f.v.a * v.f.e.num) + (delta.v.a * i.f.v.a.num) + (delta.v.s * i.f.v.s.num) + (kappa * s.f.e.num) - (age.out * v.f.e.num) - (mu * v.f.e.num)
...
# 6.Outputs
# should we add sv.flow for catch-up vax?
...
init2 <- init.dcm(s.m.ue.num = 1600000, s.m.e.num = 3800000,
                 i.m.s.a.num = 1300000, i.m.s.s.num = 1300000,
                 v.m.ue.num = 304000, v.m.e.num = 304000, 
                 i.m.v.a.num = 1300000, i.m.v.s.num = 1300000,
                 s.f.ue.num = 1700000, s.f.e.num = 3800000, 
...
mod <- mutate_epi(mod, m.num = s.m.ue.num + s.m.e.num + i.m.s.a.num + i.m.s.s.num + v.m.ue.num + v.m.e.num + i.m.v.a.num + i.m.v.s.num + s.m.e.num)

mod <- mutate_epi(mod, f.num = s.f.ue.num + s.f.e.num + i.f.s.a.num + i.f.s.s.num + v.f.ue.num + v.f.e.num + i.f.v.a.num + i.f.v.s.num + s.f.e.num)

mod <- mutate_epi(mod, i.m.num = i.m.s.a.num + i.m.s.s.num + i.m.v.a.num + i.m.v.s.num)
mod <- mutate_epi(mod, i.f.num = i.f.s.a.num + i.f.s.s.num + i.f.v.a.num + i.f.v.s.num)
...
mod2 <- mutate_epi(mod2, m.num = s.m.ue.num + s.m.e.num + i.m.s.a.num + i.m.s.s.num + v.m.ue.num + v.m.e.num + i.m.v.a.num + i.m.v.s.num + s.m.e.num)

mod2 <- mutate_epi(mod2, f.num = s.f.ue.num + s.f.e.num + i.f.s.a.num + i.f.s.s.num + v.f.ue.num + v.f.e.num + i.f.v.a.num + i.f.v.s.num + s.f.e.num)

mod2 <- mutate_epi(mod2, i.m.num = i.m.s.a.num + i.m.s.s.num + i.m.v.a.num + i.m.v.s.num)
mod2 <- mutate_epi(mod2, i.f.num = i.f.s.a.num + i.f.s.s.num + i.f.v.a.num + i.f.v.s.num)
