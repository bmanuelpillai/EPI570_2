...
plot(mod, y = c("m.prev", "f.prev"), 
     main = "Proportional Prevalence\n(Catch Up Vac.)",
     ylim = c(0.5,0.65), xlim = c(10950, 25000),
     col = c("blue", "pink"))

legend("topright", legend = c("Male Prevalence", "Female Prevalence"), 
       col = c("blue", "pink"), pch = 19, cex = 0.5)

# Prevalence Vaccinated
plot(mod, y = c("m.vax.prev", "f.vax.prev"), 
     main = "Vaccianted\nProportional Prevalence\n(Catch Up Vac.)",
     ylim = c(0.4,0.65), xlim = c(10950, 25000),
     col = c("blue", "pink"))

legend("topright", legend = c("Vaccianted Male Prevalence", "Vaccinated Female Prevalence"), 
       col = c("blue", "pink"), pch = 19, cex = 0.5)
```
...
# Prevalence Overall
par(mfrow = c(1,2))
plot(mod, y = c("si.m.flow", "si.f.flow"), 
     main = "Incidence\n(Catch Up Vac.)",
     ylim = c(2000, 9000), xlim = c(10950, 25000),
     col = c("blue", "pink"))

legend("bottomright", legend = c("Male Incidence", "Female Incidence"), 
       col = c("blue", "pink"), pch = 19, cex = 0.6)

# Prevalence Vaccinated
plot(mod, y = c("vi.m.flow", "vi.f.flow"), 
     main = "Vaccianted\nIncidence\n(Catch Up Vac.)",
     ylim = c(2000,4500), xlim = c(10950, 25000),
     col = c("blue", "pink"))

legend("bottomright", legend = c("Vaccianted Male Incidence", "Vaccinated Female Incidence"), 
       col = c("blue", "pink"), pch = 19, cex = 0.6)
```
```{r Incidence}
par(mfrow = c(1,2))
