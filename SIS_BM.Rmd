...
param <- param.dcm(omega.m = 0.10, omega.f = 0.40, lifespan = (11*365),
                   psi = 0.90, dur.inf = (1.5*365), ce.m = 5, tau = 0.74)

init <- init.dcm(s.m.num = 1000, i.m.num = 1000, v.m.num = 1000, si.m.flow = 0,vi.m.flow = 0,
                 s.f.num = 1000, i.f.num = 1000, v.f.num = 1000, si.f.flow = 0, vi.f.flow = 0)
